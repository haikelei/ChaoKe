...
public class ShouFangJiaoGeListActivity extends BaseActivity {
    ...
    private void loadData() {
        HttpManager.post(HttpManager.SHOUFANGJIAOGE_LIST)
                ...
                .execute(new SimpleCallBack<ShouFangJiaoGeBean>() {
                    ...
                    public void onSuccess(ShouFangJiaoGeBean data) {
                        ...
                        viewPager.setAdapter(new ShouFangJiaoGePagerAdapter(getSupportFragmentManager(),data));
